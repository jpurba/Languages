...
* July 23, 2020
*
* File name: chap20_recursion_queue_extra.cpp
*
*/
#include <iostream>
#include <string>
...
int main()
{
    ...
    result = test.searchName("Bob Smith");
    cout << endl;
    result = test.searchName("Tom Sawyer");

    test.displayQueue();
    cout << endl;

    //3. Append more names to the queue.
    test.enqueue("Joe Lennon", 4);
    cout << endl;
    ...
    //test.enqueue("", 1);
    //test.enqueue(" ", 1);
    //test.enqueue("abcdefghijklmnopqrst ", 1);
...
void enqueueNode(DynamicQueues& list)
{
    ...
    //position = customerName.find(" ");

    
    //cout << "\nenqueueNode: customerName: " << customerName
    //    << "; length: " << customerName.length() << "; position: " << position << endl;
...
bool validateString(const std::string& stringInput)
{
    ...
    //cout << "\nvalidateString: stringInput: " << stringInput
    //    << "length: " << stringInput.length() << endl;
    position = stringInput.find(" ");
    //cout << "\nposition of space in stringInput: " << position << endl;

    // If the input has 2 words and space in between
    if ((position > 0) && (stringInput.length() > 0))
    {
    ...
    else
    {
        ...
        for (const char charInput : stringInput)
        {
            // check if the character is not a digit number or blank 
