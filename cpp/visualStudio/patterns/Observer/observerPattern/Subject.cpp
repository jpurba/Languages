...
// ----------
void Subject::attach(InterfaceObserver* observer) {
...
// -----------
void Subject::detach(InterfaceObserver* observer) {
...
void Subject::notify() {
	...
	list<InterfaceObserver*>::iterator iterator = _listObserver.begin();
