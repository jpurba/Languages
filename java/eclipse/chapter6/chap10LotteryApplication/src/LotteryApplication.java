...
{	
	...
	{
		LotteryApplication LotteryApplication = new LotteryApplication();
		...
		userPicks = LotteryApplication.inputUserPicks();
		
		// get winning pick number
		winningNumbers = LotteryApplication.pickWinningNumbers();
		
		System.out.println("User pick numbers are: " + LotteryApplication.arrayToString(userPicks));
		
		System.out.println("The winning numbers are: " + LotteryApplication.arrayToString(winningNumbers));

		System.out.println("Number of matching numbers: " + LotteryApplication.getNumberOfMatches(userPicks, winningNumbers));
	}
